...
// Для каждой задачи необходимо создать отдельную функцию.

// 1. Sort the array of users by "first" name in ascending order. (userSorted)
// Сортировать массив пользователей по имени "first" в порядке возрастания. (userSorted)

// 2. Calculate the total salary of all users and log the overall amount. (customersSalary)
// Рассчитать общую зарплату всех пользователей и вывести общую сумму. (customersSalary)

// 3. Create a new array that filters out all users whose friend count is less than 8. (filterUser)
// Создайте новый массив, в который будут отфильтрованы все пользователи,
// у которых количество друзей меньше 8. (filterUser)

// 4. Map over the user array to collect all friends into a single array. (mappedUsers)
// Сопоставьте массив пользователей, чтобы собрать всех друзей в один массив. (mappedUsers)
...
// Объедините данные и создайте новый массив из массива пользователей,
// включая следующие поля: _id, name и isActive. (mappedUsers)
...
//   return array.sort((a, b) => a.name.first.localeCompare(b.name.first));
// }
// console.log(sortByUsername(userSorted));
//============================================================================
// 2 task
//   function calculateTotalSalary(customersSalary) {
//    return customersSalary.reduce((sum, current) => sum + +current.salary, 0);
//   }
//   console.log(calculateTotalSalary(customersSalary));

// or
//  function calculateTotalSalary(customersSalary) {
//    let sum = 0;
//    for (let elem of customersSalary) {
//       sum += Number(elem.salary);
//    }
//    return sum;
//  }
//  console.log(calculateTotalSalary(customersSalary));  // 601645.8391999999

//============================================================================
// 3 task
// function filterAllUsers(users) {
//    return users.filter((user) => user.friends.length > 7);
// }
// console.log(filterAllUsers(filterUser));

//============================================================================
// 4 task
// const gatherAllFriends = function(users) {
//    let allFriends = [];
//    users.forEach((user) => {
...
//    return allFriends;
// }
// console.log(gatherAllFriends(mappedUsers));

//============================================================================
// 5 task
// function createNewArr(users) {
//   return users.map(({ _id, name, isActive }) => {
//     return { _id: _id, name: name, isActive: isActive };
//   });
// }
// console.log(createNewArr(mappedUsers));
//============================================================================
